...
<!-- use venv for logical separation  -->

**Example:**

```bash
# Create a virtual environment and myenv : environment name i can use my own specified name
python -m venv myenv
...
```
<!-- to come out of created venv use this command: deactivate -->
